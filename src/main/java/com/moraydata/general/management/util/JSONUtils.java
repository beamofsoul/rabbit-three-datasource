...
public class JSONUtils {
	 ...
	 */
	public static JSONObject formatAndParseObject(@NonNull String jsonStr, @NonNull final String replaceFrom, Feature... features) {
	 ...
	 * @return JSONObject 格式化和解析后生成的JSON对象  
	 */
	public static JSONObject formatAndParseObject(@NonNull String jsonStr, Feature... features) {
		return formatAndParseObject(jsonStr, "=", features);
	}
	
	/**
	 * @Title: formatAndParseObject  
	 * @Description: 格式化并且解析JSON字符串Object对象并返回JSON对象
	 * @param jsonStrObject 格式化前的JSON字符串Object对象
	 * @return JSONObject 格式化和解析后生成的JSON对象
	 */
	public static JSONObject formatAndParseObject(Object jsonStrObject) {
		return jsonStrObject != null ? formatAndParseObject(jsonStrObject.toString(), new Feature[] {}) : null;
	}
	 ...
	 */
	public static JSONArray formatAndParseArray(@NonNull String jsonStr, @NonNull final String replaceForm) {
	 ...
	 * @return JSONArray 格式化和解析后生成的JSON数组
	 */
	public static JSONArray formatAndParseArray(@NonNull String jsonStr) {
