...
public class PageUtils {
	...
	public static Pageable parsePageable(Map<String, Object> map) {
		Object sortByStr = map.get(Constants.PAGEABLE.SORT_BY_NAME);
		if (sortByStr == null || (sortByStr != null && StringUtils.isBlank(sortByStr.toString()))) {
			return parsePageable(map, Constants.ENTITY.DEFAULT_PRIMARY_KEY);
		} else {
			Object directionNum = map.get(Constants.PAGEABLE.SORT_DIRECTION_NAME);
	...
	public static Pageable parsePageable(Map<String, Object> map, Direction direction) {
		return parsePageable(map, new Sort(direction, Constants.ENTITY.DEFAULT_PRIMARY_KEY));
	}
	...
	public static Pageable parsePageable(Map<String, Object> map, Sort sort) {
		return parsePageable(Integer.valueOf(map.get(Constants.PAGEABLE.PAGE_NUMBER_NAME).toString()), Integer.valueOf(map.get(Constants.PAGEABLE.PAGE_SIZE_NAME).toString()), sort);
	}
	...
	public static Pageable parsePageable(int pageNumber, int pageSize, Direction direction) {
		return parsePageable(pageNumber, pageSize, new Sort(direction, Constants.ENTITY.DEFAULT_PRIMARY_KEY));
	}
